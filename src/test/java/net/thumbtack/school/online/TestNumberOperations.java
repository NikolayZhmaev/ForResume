package net.thumbtack.school.online;

import net.thumbtack.school.online.base.NumberOperations;
...
public class TestNumberOperations {
    ...
    public void testFindInteger() {
        Assert.assertEquals((Integer) 3, NumberOperations.find(new int[]{0, 2, 4, 6, 8}, 6));
